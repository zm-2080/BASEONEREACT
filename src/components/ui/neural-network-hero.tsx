...
export default function Hero({
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen w-screen overflow-hidden bg-white">
      ...
      <div className="absolute top-8 sm:top-10 md:top-12 left-0 w-full z-20 flex justify-start md:justify-center overflow-hidden px-8 sm:px-12 md:px-16 lg:px-20">
